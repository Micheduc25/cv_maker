...
// if user already has a CV in the database we redirect user to edit-cv.php page
if (mysqli_num_rows($result) > 0) {
    header("Location: edit-cv.php");
}
...
<body>
    ...
    <div class="container mt-5">
        <h2>CV Creation Form</h2>
        <form action="cv-creation-process.php" method="post">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="education" name="education" rows="5" required></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="skills" name="skills" rows="5" required></textarea>
            </div>
